...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_m_randomA_initialized__h17164;
	 tUInt8 DEF_INST_top_DEF_m_randomB_initialized__h17553;
	 tUInt8 DEF_INST_top_DEF_m_randomData_initialized__h18330;
	 tUInt8 DEF_INST_top_DEF_m_ref_fifo_ref_noncf_fifo_i_notEmpty____d154;
	 tUInt8 DEF_INST_top_DEF_m_randomC_initialized__h17940;
	 ...
	 INST_top.DEF_CAN_FIRE_RL_fifo_ehr_deq_canonicalize = (tUInt8)1u;
	 INST_top.DEF_WILL_FIRE_RL_fifo_ehr_deq_canonicalize = INST_top.DEF_CAN_FIRE_RL_fifo_ehr_deq_canonicalize;
	 INST_top.DEF_CAN_FIRE_RL_fifo_ehr_enq_canonicalize = (tUInt8)1u;
	 INST_top.DEF_WILL_FIRE_RL_fifo_ehr_enq_canonicalize = INST_top.DEF_CAN_FIRE_RL_fifo_ehr_enq_canonicalize;
	 ...
	 INST_top.DEF_x__h21316 = INST_top.INST_m_cycle.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_m_init = (INST_top.DEF_x__h21316) == 0u;
	 INST_top.DEF_WILL_FIRE_RL_m_init = INST_top.DEF_CAN_FIRE_RL_m_init;
	 DEF_INST_top_DEF_m_randomC_initialized__h17940 = INST_top.INST_m_randomC_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_m_maybe_clear = DEF_INST_top_DEF_m_randomC_initialized__h17940;
	 ...
	 DEF_INST_top_DEF_m_randomA_initialized__h17164 = INST_top.INST_m_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_m_randomA_every_1 = !DEF_INST_top_DEF_m_randomA_initialized__h17164;
	 INST_top.DEF_WILL_FIRE_RL_m_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_m_randomA_every_1;
	 DEF_INST_top_DEF_m_randomB_initialized__h17553 = INST_top.INST_m_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_m_randomB_every_1 = !DEF_INST_top_DEF_m_randomB_initialized__h17553;
	 ...
	 INST_top.DEF_CAN_FIRE_RL_m_randomC_every_1 = !DEF_INST_top_DEF_m_randomC_initialized__h17940;
	 INST_top.DEF_WILL_FIRE_RL_m_randomC_every_1 = INST_top.DEF_CAN_FIRE_RL_m_randomC_every_1;
	 DEF_INST_top_DEF_m_randomData_initialized__h18330 = INST_top.INST_m_randomData_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_m_randomData_every_1 = !DEF_INST_top_DEF_m_randomData_initialized__h18330;
	 ...
	 DEF_INST_top_DEF_m_ref_fifo_ref_noncf_fifo_i_notEmpty____d154 = INST_top.INST_m_ref_fifo_ref_noncf_fifo.METH_i_notEmpty();
	 INST_top.DEF_CAN_FIRE_RL_m_ref_fifo_pre_canonicalize_two = DEF_INST_top_DEF_m_ref_fifo_ref_noncf_fifo_i_notEmpty____d154;
	 INST_top.DEF_WILL_FIRE_RL_m_ref_fifo_pre_canonicalize_two = INST_top.DEF_CAN_FIRE_RL_m_ref_fifo_pre_canonicalize_two;
	 INST_top.DEF_x__h21168 = INST_top.INST_m_input_count.METH_read();
	 INST_top.DEF_m_input_count_19_EQ_1024___d290 = (INST_top.DEF_x__h21168) == 1024u;
	 INST_top.DEF_CAN_FIRE_RL_m_stop_tb = INST_top.DEF_m_input_count_19_EQ_1024___d290 || (INST_top.DEF_x__h21316) == 4096u;
	 ...
	 INST_top.DEF_x_wget__h17033 = INST_top.INST_m_randomA_zaz.METH_wget();
	 INST_top.DEF_m_ref_fifo_ehrReg_3__h13326 = INST_top.INST_m_ref_fifo_ehrReg_3.METH_read();
	 INST_top.DEF_v__h17170 = INST_top.INST_m_randomA_zaz.METH_whas() ? INST_top.DEF_x_wget__h17033 : (tUInt8)0u;
	 INST_top.DEF_IF_m_ref_fifo_wires_0_3_whas__40_THEN_m_ref_fi_ETC___d143 = INST_top.INST_m_ref_fifo_wires_0_3.METH_whas() ? INST_top.INST_m_ref_fifo_wires_0_3.METH_wget() : INST_top.DEF_m_ref_fifo_ehrReg_3__h13326;
	 INST_top.DEF_IF_m_randomA_zaz_whas__86_THEN_m_randomA_zaz_w_ETC___d212 = (INST_top.DEF_v__h17170) == (tUInt8)0u;
	 INST_top.DEF_NOT_m_ref_fifo_virtual_reg_1_3_read__13_14_AND_ETC___d215 = !INST_top.INST_m_ref_fifo_virtual_reg_1_3.METH_read() && INST_top.DEF_IF_m_ref_fifo_wires_0_3_whas__40_THEN_m_ref_fi_ETC___d143;
	 INST_top.DEF_CAN_FIRE_RL_m_feed_inputs = (DEF_INST_top_DEF_m_randomA_initialized__h17164 && (INST_top.DEF_IF_m_randomA_zaz_whas__86_THEN_m_randomA_zaz_w_ETC___d212 || (DEF_INST_top_DEF_m_randomData_initialized__h18330 && INST_top.DEF_NOT_m_ref_fifo_virtual_reg_1_3_read__13_14_AND_ETC___d215))) && (INST_top.DEF_x__h21168) < 1024u;
	 ...
	 INST_top.DEF_x_wget__h17422 = INST_top.INST_m_randomB_zaz.METH_wget();
	 INST_top.DEF_m_ref_fifo_ehrReg_4__h14162 = INST_top.INST_m_ref_fifo_ehrReg_4.METH_read();
	 INST_top.DEF_v__h17559 = INST_top.INST_m_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h17422 : (tUInt8)0u;
	 INST_top.DEF_IF_m_ref_fifo_wires_0_4_whas__47_THEN_m_ref_fi_ETC___d150 = INST_top.INST_m_ref_fifo_wires_0_4.METH_whas() ? INST_top.INST_m_ref_fifo_wires_0_4.METH_wget() : INST_top.DEF_m_ref_fifo_ehrReg_4__h14162;
	 INST_top.DEF_IF_m_randomB_zaz_whas__93_THEN_m_randomB_zaz_w_ETC___d246 = (INST_top.DEF_v__h17559) == (tUInt8)0u;
	 INST_top.DEF_NOT_m_ref_fifo_virtual_reg_1_4_read__47_48_AND_ETC___d249 = !INST_top.INST_m_ref_fifo_virtual_reg_1_4.METH_read() && INST_top.DEF_IF_m_ref_fifo_wires_0_4_whas__47_THEN_m_ref_fi_ETC___d150;
	 INST_top.DEF_CAN_FIRE_RL_m_check_outputs = DEF_INST_top_DEF_m_randomB_initialized__h17553 && (INST_top.DEF_IF_m_randomB_zaz_whas__93_THEN_m_randomB_zaz_w_ETC___d246 || INST_top.DEF_NOT_m_ref_fifo_virtual_reg_1_4_read__47_48_AND_ETC___d249);
	 ...
	 INST_top.DEF_m_ref_fifo_virtual_reg_2_read____d156 = INST_top.INST_m_ref_fifo_virtual_reg_2.METH_read();
	 INST_top.DEF_m_ref_fifo_virtual_reg_1_read____d157 = INST_top.INST_m_ref_fifo_virtual_reg_1.METH_read();
	 INST_top.DEF_m_ref_fifo_ehrReg___d100 = INST_top.INST_m_ref_fifo_ehrReg.METH_read();
	 INST_top.DEF_m_ref_fifo_wires_0_wget____d98 = INST_top.INST_m_ref_fifo_wires_0.METH_wget();
	 INST_top.DEF_m_ref_fifo_virtual_reg_2_1_read____d162 = INST_top.INST_m_ref_fifo_virtual_reg_2_1.METH_read();
	 INST_top.DEF_m_ref_fifo_virtual_reg_1_1_read____d163 = INST_top.INST_m_ref_fifo_virtual_reg_1_1.METH_read();
	 INST_top.DEF_m_ref_fifo_wires_0_1_whas____d125 = INST_top.INST_m_ref_fifo_wires_0_1.METH_whas();
	 INST_top.DEF_m_ref_fifo_wires_0_1_wget____d126 = INST_top.INST_m_ref_fifo_wires_0_1.METH_wget();
	 INST_top.DEF_m_ref_fifo_ehrReg_1__h11517 = INST_top.INST_m_ref_fifo_ehrReg_1.METH_read();
	 INST_top.DEF_m_ref_fifo_wires_0_whas____d97 = INST_top.INST_m_ref_fifo_wires_0.METH_whas();
	 INST_top.DEF_m_ref_fifo_ehrReg_00_BIT_8___d101 = (tUInt8)((INST_top.DEF_m_ref_fifo_ehrReg___d100) >> 8u);
	 INST_top.DEF_m_ref_fifo_wires_0_wget__8_BIT_8___d99 = (tUInt8)((INST_top.DEF_m_ref_fifo_wires_0_wget____d98) >> 8u);
	 INST_top.DEF_CAN_FIRE_RL_m_ref_fifo_post_canonicalize = ((INST_top.DEF_m_ref_fifo_virtual_reg_2_read____d156 || (INST_top.DEF_m_ref_fifo_virtual_reg_1_read____d157 || (INST_top.DEF_m_ref_fifo_wires_0_whas____d97 ? !(INST_top.DEF_m_ref_fifo_wires_0_wget__8_BIT_8___d99) : !(INST_top.DEF_m_ref_fifo_ehrReg_00_BIT_8___d101)))) || INST_top.INST_m_ref_fifo_ref_noncf_fifo.METH_i_notFull()) && ((INST_top.DEF_m_ref_fifo_virtual_reg_2_1_read____d162 || (INST_top.DEF_m_ref_fifo_virtual_reg_1_1_read____d163 || (INST_top.DEF_m_ref_fifo_wires_0_1_whas____d125 ? !(INST_top.DEF_m_ref_fifo_wires_0_1_wget____d126) : !(INST_top.DEF_m_ref_fifo_ehrReg_1__h11517)))) || DEF_INST_top_DEF_m_ref_fifo_ref_noncf_fifo_i_notEmpty____d154);
	 ...
	 if (INST_top.DEF_WILL_FIRE_RL_fifo_ehr_deq_canonicalize)
	   INST_top.RL_fifo_ehr_deq_canonicalize();
	 if (INST_top.DEF_WILL_FIRE_RL_fifo_ehr_enq_canonicalize)
	   INST_top.RL_fifo_ehr_enq_canonicalize();
	 ...
	 INST_top.INST_fifo_ehr_deq_ignored_wires_2.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_deq_ignored_wires_1.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_deq_ignored_wires_0.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_deq_wires_2.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_deq_wires_1.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_deq_wires_0.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_enq_ignored_wires_2.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_enq_ignored_wires_1.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_enq_ignored_wires_0.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_enq_wires_2.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_enq_wires_1.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_fifo_ehr_enq_wires_0.clk((tUInt8)1u, (tUInt8)1u);
	 ...
	 if (do_reset_ticks(simHdl))
	 {
	   ...
	   INST_top.INST_fifo_ehr_enq_ehrReg.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_fifo_ehr_deq_ehrReg.rst_tick__clk__1((tUInt8)1u);
...
void MODEL_mkTbCFFunctional::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTbCFFunctional_instance->INST_fifo_enqP_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_enqP_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_enqP_ignored_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_enqP_ignored_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_deqP_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_deqP_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_deqP_ignored_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_deqP_ignored_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_last_write_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_last_write_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_last_write_wires_2.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_last_write_ignored_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_last_write_ignored_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_last_write_ignored_wires_2.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_enq_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_enq_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_enq_wires_2.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_enq_ignored_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_enq_ignored_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_enq_ignored_wires_2.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_deq_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_deq_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_deq_wires_2.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_deq_ignored_wires_0.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_deq_ignored_wires_1.set_clk_0)("CLK");
  (mkTbCFFunctional_instance->INST_fifo_ehr_deq_ignored_wires_2.set_clk_0)("CLK");
...
time_t MODEL_mkTbCFFunctional::get_creation_time()
{
  ...
  /* Sun Apr 26 01:32:49 UTC 2026 */
  return 1777167169llu;
}
