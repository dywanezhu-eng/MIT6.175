...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h1487;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h1913;
	 INST_top.DEF__read__h142 = INST_top.INST_dut_i.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_dut_mul_step = (INST_top.DEF__read__h142) < (tUInt8)16u;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h1487 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h1487;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1;
	 DEF_INST_top_DEF_tb_randomB_initialized__h1913 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h1913;
	 ...
	 INST_top.DEF_x__h2833 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF_dut_i_EQ_16___d75 = (INST_top.DEF__read__h142) == (tUInt8)16u;
	 INST_top.DEF_tb_read_count_2_EQ_128___d73 = (INST_top.DEF_x__h2833) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_2_EQ_128___d73) && INST_top.DEF_dut_i_EQ_16___d75);
	 ...
	 INST_top.DEF_x__h2294 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h1745 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h1318 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 INST_top.DEF_v__h1493 = INST_top.INST_tb_randomA_zaz.METH_whas() ? INST_top.DEF_x_wget__h1318 : 0u;
	 INST_top.DEF_v__h1919 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1745 : 0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d48 = (INST_top.DEF_v__h1493) == 2147483648u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__5_THEN_tb_randomB_zaz__ETC___d49 = (INST_top.DEF_v__h1919) == 2147483648u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h1487 && (DEF_INST_top_DEF_tb_randomB_initialized__h1913 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__9_THEN_tb_randomA_zaz__ETC___d48 || INST_top.DEF_IF_tb_randomB_zaz_whas__5_THEN_tb_randomB_zaz__ETC___d49) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h2294) == 128u) && (INST_top.DEF__read__h142) == (tUInt8)17u)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 || INST_top.DEF_CAN_FIRE_RL_dut_mul_step);
...
time_t MODEL_mkTbEx9a::get_creation_time()
{
  ...
  /* Sun Apr  5 06:20:33 UTC 2026 */
  return 1775370033llu;
}
