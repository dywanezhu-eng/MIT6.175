...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h1051;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h1477;
	 INST_top.DEF__read__h139 = INST_top.INST_dut_i.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_dut_mul_step = (INST_top.DEF__read__h139) < (tUInt8)32u;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h1051 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h1051;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1;
	 DEF_INST_top_DEF_tb_randomB_initialized__h1477 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h1477;
	 ...
	 INST_top.DEF_x__h2388 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF_dut_i_EQ_32___d56 = (INST_top.DEF__read__h139) == (tUInt8)32u;
	 INST_top.DEF_tb_read_count_3_EQ_128___d54 = (INST_top.DEF_x__h2388) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = INST_top.INST_tb_operands_fifo.METH_i_notEmpty() && (!(INST_top.DEF_tb_read_count_3_EQ_128___d54) && INST_top.DEF_dut_i_EQ_32___d56);
	 ...
	 INST_top.DEF_x__h1849 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h1309 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h882 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 INST_top.DEF_tb_randomA_zaz_whas____d20 = INST_top.INST_tb_randomA_zaz.METH_whas();
	 INST_top.DEF_v__h1057 = INST_top.DEF_tb_randomA_zaz_whas____d20 ? INST_top.DEF_x_wget__h882 : 0u;
	 INST_top.DEF_v__h1483 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1309 : 0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__0_THEN_tb_randomA_zaz__ETC___d29 = (INST_top.DEF_v__h1057) == 2147483648u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__6_THEN_tb_randomB_zaz__ETC___d30 = (INST_top.DEF_v__h1483) == 2147483648u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h1051 && (DEF_INST_top_DEF_tb_randomB_initialized__h1477 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__0_THEN_tb_randomA_zaz__ETC___d29 || INST_top.DEF_IF_tb_randomB_zaz_whas__6_THEN_tb_randomB_zaz__ETC___d30) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h1849) == 128u) && (INST_top.DEF__read__h139) == (tUInt8)33u)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 || INST_top.DEF_CAN_FIRE_RL_dut_mul_step);
