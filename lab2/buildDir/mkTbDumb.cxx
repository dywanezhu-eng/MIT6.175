...
/* Constructor */
MOD_mkTbDumb::MOD_mkTbDumb(tSimStateHdl simHdl, char const *name, Module *parent)
...
void MOD_mkTbDumb::init_symbols_0()
{
...
void MOD_mkTbDumb::RL_tb_randomA_every()
{
...
void MOD_mkTbDumb::RL_tb_randomA_every_1()
{
...
void MOD_mkTbDumb::RL_tb_randomB_every()
{
...
void MOD_mkTbDumb::RL_tb_randomB_every_1()
{
...
void MOD_mkTbDumb::RL_tb_test()
{
  ...
  tUInt32 DEF_signed_0_CONCAT_IF_tb_randomA_zaz_whas_THEN_t_ETC___d36;
  ...
  DEF_x_wget__h264 = INST_tb_randomA_zaz.METH_wget();
  DEF_v__h410 = INST_tb_randomA_zaz.METH_whas() ? DEF_x_wget__h264 : (tUInt8)0u;
  DEF_test__h1177 = (tUInt32)(65535u & ((65535u & ((((tUInt32)((tUInt8)0u)) << 8u) | (tUInt32)(DEF_v__h410))) * (65535u & ((((tUInt32)((tUInt8)0u)) << 8u) | (tUInt32)(DEF_v__h799)))));
  DEF_signed_0_CONCAT_IF_tb_randomA_zaz_whas_THEN_t_ETC___d36 = DEF_test__h1177;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_NOT_tb_cycle_5_EQ_0_6_1_AND_NOT_tb_cycle_5_EQ__ETC___d29)
      dollar_display(sim_hdl,
		     ...
		     DEF_signed_0_CONCAT_IF_tb_randomA_zaz_whas_THEN_t_ETC___d36);
    if (DEF_NOT_tb_cycle_5_EQ_0_6_1_AND_NOT_tb_cycle_5_EQ__ETC___d29)
      dollar_display(sim_hdl,
		     this,
		     "s,8,8,16",
...
void MOD_mkTbDumb::reset_RST_N(tUInt8 ARG_rst_in)
{
...
void MOD_mkTbDumb::set_clk_0(char const *s)
{
...
void MOD_mkTbDumb::dump_state(unsigned int indent)
{
  printf("%*s%s:\n", indent, "", inst_name);
...
unsigned int MOD_mkTbDumb::dump_VCD_defs(unsigned int levels)
{
...
void MOD_mkTbDumb::dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkTbDumb &backing)
{
  vcd_defs(dt, backing);
  vcd_prims(dt, backing);
}

void MOD_mkTbDumb::vcd_defs(tVCDDumpType dt, MOD_mkTbDumb &backing)
{
  unsigned int num = vcd_num;
  if (dt == VCD_DUMP_XS)
  {
...
void MOD_mkTbDumb::vcd_prims(tVCDDumpType dt, MOD_mkTbDumb &backing)
{
