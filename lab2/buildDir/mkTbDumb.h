...
#ifndef __mkTbDumb_h__
#define __mkTbDumb_h__
...
/* Class declaration for the mkTbDumb module */
class MOD_mkTbDumb : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkTbDumb(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkTbDumb &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkTbDumb &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkTbDumb &backing);
};

#endif /* ifndef __mkTbDumb_h__ */
