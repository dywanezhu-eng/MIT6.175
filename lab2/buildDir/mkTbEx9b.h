...
class MOD_mkTbEx9b : public Module {
 ...
 public:
  ...
  tUInt32 DEF_x__h2759;
  tUInt32 DEF_x__h2220;
  tUInt32 DEF_x_wget__h1708;
  tUInt8 DEF_dut_i_EQ_8___d77;
  tUInt32 DEF_v__h1456;
  tUInt32 DEF_v__h1845;
  tUInt8 DEF_tb_read_count_4_EQ_128___d75;
  tUInt8 DEF_IF_tb_randomA_zaz_whas__0_THEN_tb_randomA_zaz__ETC___d50;
  tUInt8 DEF_IF_tb_randomB_zaz_whas__7_THEN_tb_randomB_zaz__ETC___d51;
 
 /* Local definitions */
 private:
  tUInt32 DEF_v__h1765;
  tUInt32 DEF_v__h1375;
  tUInt64 DEF_dut_p__h2331;
