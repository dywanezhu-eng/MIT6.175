...
CFLAGS_COMMON = -O -g -I$(DTOP)/jni -I$(CONNECTALDIR) -I$(CONNECTALDIR)/cpp -I$(CONNECTALDIR)/lib/cpp   -Wall -Werror -I$(DTOP)/jni -I$(CONNECTALDIR) -I$(CONNECTALDIR)/cpp -I$(CONNECTALDIR)/lib/cpp  -Wno-error=address -Wno-address
CFLAGS = $(CFLAGS_COMMON)
CFLAGS2 = 

include $(DTOP)/Makefile.autotop
include $(CONNECTALDIR)/scripts/Makefile.connectal.application
SOURCES = /home/dywane_zhu/MIT_6.175/lab5/main.cpp /home/dywane_zhu/MIT_6.175/lab5/connectal/cpp/dmaManager.c /home/dywane_zhu/MIT_6.175/lab5/connectal/cpp/platformMemory.cpp /home/dywane_zhu/MIT_6.175/lab5/connectal/cpp/transportXsim.c $(PORTAL_SRC_FILES)
