...
class MOD_mkProc : public Module {
 ...
 public:
  ...
  tUWide DEF_exec___d40;
  tUWide DEF_decode_5_BITS_74_TO_64_6_CONCAT_decode_5_BIT_6_ETC___d36;
  tUInt32 DEF_rVal1__h398;
  tUInt32 DEF_rVal2__h399;
  tUInt32 DEF_a__h455;
  tUInt32 DEF_csrVal__h400;
  tUWide DEF_decode___d15;
  tUInt32 DEF_iMem_req_pc_3___d14;
  tUInt32 DEF_idx__h865;
  tUInt8 DEF_rindx__h837;
  tUInt8 DEF_rindx__h814;
  tUInt8 DEF_csrf_started____d56;
  tUInt8 DEF_dMem_init_done____d6;
  tUInt8 DEF_iMem_init_done____d4;
  tUInt8 DEF_exec_0_BITS_88_TO_85___d41;
  tUInt8 DEF_exec_0_BIT_84___d48;
  tUInt8 DEF_exec_0_BITS_88_TO_85_1_EQ_2___d42;
  tUInt8 DEF_exec_0_BITS_88_TO_85_1_EQ_3___d44;
  tUInt8 DEF_NOT_exec_0_BITS_88_TO_85_1_EQ_2_2___d50;
 
 /* Local definitions */
 private:
  tUWide DEF__1_CONCAT_DONTCARE___d10;
  tUWide DEF_dMemInit_request_put_BIT_64_44_CONCAT_IF_dMemI_ETC___d247;
  tUWide DEF_iMemInit_request_put_BIT_64_40_CONCAT_IF_iMemI_ETC___d243;
  tUWide DEF_NOT_exec_0_BITS_88_TO_85_1_EQ_2_2_0_CONCAT_IF__ETC___d65;
