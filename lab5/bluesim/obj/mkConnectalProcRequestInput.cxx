...
MOD_mkConnectalProcRequestInput::MOD_mkConnectalProcRequestInput(tSimStateHdl simHdl,
  ...
  : Module(simHdl, name, parent),
    ...
    INST_hostToCpu_requestAdapter_fbnbuff(simHdl,
					  ...
					  0u,
					  (tUInt8)0u),
    INST_hostToCpu_requestAdapter_fifo(simHdl, "hostToCpu_requestAdapter_fifo", this, 32u, 1u, 1u, 0u),
...
tUInt8 MOD_mkConnectalProcRequestInput::METH_RDY_portalIfc_requests_0_enq()
{
  ...
  DEF_hostToCpu_requestAdapter_fifo_notFull____d1 = INST_hostToCpu_requestAdapter_fifo.METH_notFull();
  DEF_CAN_FIRE_portalIfc_requests_0_enq = DEF_hostToCpu_requestAdapter_fifo_notFull____d1 && INST_hostToCpu_requestAdapter_fifo.METH_i_notFull();
...
tUInt8 MOD_mkConnectalProcRequestInput::METH_portalIfc_requests_0_notFull()
{
  ...
  DEF_hostToCpu_requestAdapter_fifo_notFull____d1 = INST_hostToCpu_requestAdapter_fifo.METH_notFull();
  PORT_portalIfc_requests_0_notFull = DEF_hostToCpu_requestAdapter_fifo_notFull____d1;
...
tUInt8 MOD_mkConnectalProcRequestInput::METH_RDY_pipes_hostToCpu_PipeOut_first()
{
  ...
  DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3 = INST_hostToCpu_requestAdapter_fifo.METH_i_notEmpty();
  DEF_CAN_FIRE_pipes_hostToCpu_PipeOut_first = DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3;
...
tUInt8 MOD_mkConnectalProcRequestInput::METH_RDY_pipes_hostToCpu_PipeOut_deq()
{
  ...
  DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3 = INST_hostToCpu_requestAdapter_fifo.METH_i_notEmpty();
  DEF_CAN_FIRE_pipes_hostToCpu_PipeOut_deq = DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3;
...
unsigned int MOD_mkConnectalProcRequestInput::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "hostToCpu_requestAdapter_fifo_i_notEmpty____d3", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "hostToCpu_requestAdapter_fifo_notFull____d1", 1u);
					       ...
					       MOD_mkConnectalProcRequestInput &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3) != DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3)
      {
	vcd_write_val(sim_hdl, num, DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3, 1u);
	backing.DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3 = DEF_hostToCpu_requestAdapter_fifo_i_notEmpty____d3;
      }
      ++num;
      if ((backing.DEF_hostToCpu_requestAdapter_fifo_notFull____d1) != DEF_hostToCpu_requestAdapter_fifo_notFull____d1)
      {
	vcd_write_val(sim_hdl, num, DEF_hostToCpu_requestAdapter_fifo_notFull____d1, 1u);
	backing.DEF_hostToCpu_requestAdapter_fifo_notFull____d1 = DEF_hostToCpu_requestAdapter_fifo_notFull____d1;
      }
      ++num;
    }
    else
